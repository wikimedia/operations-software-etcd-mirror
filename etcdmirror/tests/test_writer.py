...
class TestEtcd2Writer(unittest.TestCase):
    ...
    def test_write(self):
        ...
        self.client.write.assert_has_calls([
            mock.call('/test/some/key', 'somevalue', dir=False,
                      prevExist=False, ttl=15),
        ...
        self.client.write.assert_any_call(
            '/test/some/key', 'somevalue', prevValue='someothervalue',
            ttl=15, dir=False
        )
        self.client.write.reset_mocks()
        obj.action = 'set'
        self.writer.write(obj)
        self.client.write.assert_any_call(
            '/test/some/key', 'somevalue', ttl=15, dir=False
        )
        obj.action = 'delete'
        self.writer.write(obj)
        ...
        self.client.write.assert_called_with('/__replication/test', 1234,
                                             prevExist=True)
    ...
    def test_cleanup(self, logmocker):
        ...
        logmocker.assert_called_with(
            "Could not find %s, assuming new replica",
            '/__replication/test')
